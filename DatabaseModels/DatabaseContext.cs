...
namespace csharp_api.DatabaseModels;
...
public partial class DatabaseContext : DbContext
{
    ...
    public virtual DbSet<ProductosSinReview> ProductosSinReviews { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ProductosSinReview>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("PRODUCTOS_SIN_REVIEW", "Production");

            entity.Property(e => e.Color).HasMaxLength(15);
            entity.Property(e => e.ProductosSinReview1).HasColumnName("Productos sin review");
        });
